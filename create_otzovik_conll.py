...
def main():
    ...
    dataset.save('conll', path_to_save='data/annotation/train.tsv', sep='\t')
    dataset.documents = test_documents
    dataset.save('conll', path_to_save='data/annotation/test.tsv', sep='\t')
    dataset.save('conll', path_to_save='data/annotation/dev.tsv', sep='\t')
